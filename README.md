...
- Instance Type :- c5a.xlarge or c5a.large [4 Cpu 8Gb Ram ] 
- 30 GB EBS
- This guide assumes an Ubuntu/Debian-like environment and sudo privileges.

---
## List of Software need to install
- gitleaks
- kubectl
- eksctl
- trivy
...
**Install latest Git and Gitleaks:**
```bash
sudo add-apt-repository ppa:git-core/ppa
sudo apt update
sudo apt install git gitleaks -y
```
...
cosign generate-key-pair
```
CREATE Webhook in sonarqube server:  
...
Refer: [Trivy Installation Guide](https://trivy.dev/docs/latest/getting-started/installation/)
...
```
---
## 7. Cosign Installation

Refer: [Cosign Installation Guide](https://docs.sigstore.dev/cosign/system_config/installation/)
